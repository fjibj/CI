...
try:
    ...
    p = Popen('pip install psutil==5.4.2', stdout=PIPE, shell=True)
...
try:
    ...
    p = Popen('pip install schedule==0.5.0', stdout=PIPE, shell=True)
    stdout, stderr = p.communicate()
    print stdout
    import schedule
...
try:
    ...
    print("------------------------------------------------")
    print("begining install schedule module, please waiting")
    p = Popen('pip install requests==2.18.4', stdout=PIPE, shell=True)
    stdout, stderr = p.communicate()
    print stdout
    import requests
